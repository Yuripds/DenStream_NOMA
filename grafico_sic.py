...
def gerando_sinal(dataframe):
    ruido = 1
    sobreposicao = 1
    y = dataframe.iloc[-1].ganho* sobreposicao + ruido
    sinal_montado = 1
...
def sinal_tx(dataframe):
    ...
    for i in range(len(indices)-1):
        ...
        sinal.append(gerando_sinal(df_split))
        init = init + 1
...
sinal= sinal_tx(parametros_df_geral)
...
#    3-  Implentar o sinal recebido para diferentes valores de SINR (0 a 25 dB) ----------------------------- Fazendo
